...
(function (window, undefined) {
	window.__360browser_youtube_downloadSuccessed = true
  ...
  __360browser_youtube.prototype = {
    ...
    initPage_details: function () {
      ...
      if (window.__360browser_youtube_downloadSuccessed) {
        this.__360browser_youtube_show_download(true);
      }
    },
		//拼接style-- 播放页
		initStyle_details:function(){
			var item_height = document.getElementsByClassName('__360browser_translate_item')[0].clientHeight;
			console.log(item_height);
			document.getElementsByClassName('slim-video-metadata-header')[0].style.marginBottom = item_height+'px'
      ...
      // );
			...
			// 	style.type = 'text/css';
			// 	style.id = '__360browser_youtube_download_css';
			// 	var item_height = document.getElementsByClassName('__360browser_translate_item')[0].clientHeight;
			// 	console.log(item_height);
			// 	style.appendChild(document.createTextNode('.slim-video-metadata-actions {margin:'+ item_height+'px 0 0}'));
